...
class _PlatformAdaptingHomePageState extends State<PlatformAdaptingHomePage> {
  ...
  Widget build(context) {
    return PlatformWidget(
      androidBuilder: _buildIosHomePage,
      ...
      child: Column(
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context);
              Navigator.push<void>(context, MaterialPageRoute(builder: (context) => NewsTab()));
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context);
              Navigator.push<void>(context, MaterialPageRoute(builder: (context) => ProfileTab()));
            },
          ),
